...
internal static class PartEndpoints
{
        ...
        CancellationToken ct)
    {
        ...
        return result.IsSuccess
            ? TypedResults.Created($"/api/engineering/parts/{result.Value!.Id}", result.Value)
